...
def normalize_accession(value: str) -> str:
    ...
    least six decimal digits. Other repository identifiers may contain 3 to 64 ASCII
    letters, digits, dots, underscores, and hyphens, but must begin and end with an
    alphanumeric character and may not contain ``..``.
