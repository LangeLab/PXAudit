...
The ladder is versioned. PXAudit 0.6.0 writes `tier_logic_version = "v3.0"` into every new audit row. Re-auditing an accession applies current logic to current or cached evidence; it does not silently rewrite older rows in bulk.
